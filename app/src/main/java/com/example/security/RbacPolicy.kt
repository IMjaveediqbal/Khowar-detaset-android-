...
/** Client-side policy for UX/navigation. Server authorization remains authoritative. */
object RbacPolicy {
    private val permissions = mapOf(
        ...
        UserRole.VALIDATOR to setOf(RbacPermission.VIEW_PUBLIC_DATA, RbacPermission.CONTRIBUTE_DATA, RbacPermission.VALIDATE_COMMUNITY, RbacPermission.VERIFY_EXPERT),
    ...
    fun isPrivileged(role: UserRole?): Boolean = hasRole(role, UserRole.VALIDATOR, UserRole.EXPERT, UserRole.ADMIN, UserRole.SUPER_ADMIN)
