...
class CommunityService(
    ...
    suspend fun createPost(profile: User, title: String, body: String, category: String, linkedRecordType: String? = null, linkedRecordId: String? = null): Result<String> = runCatching {
        ensureAuthenticated()
    ...
    suspend fun reportPost(postId: String, profile: User, reason: String): Result<Unit> = runCatching {
        ...
        posts.document(postId).collection("reports").add(mapOf(
            "ownerUid" to auth.currentUser!!.uid,
